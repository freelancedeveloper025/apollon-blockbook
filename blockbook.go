...
import (
	...
	"github.com/stepollo2/apollon-blockbook/api"
	"github.com/stepollo2/apollon-blockbook/bchain"
	"github.com/stepollo2/apollon-blockbook/bchain/coins"
	"github.com/stepollo2/apollon-blockbook/common"
	"github.com/stepollo2/apollon-blockbook/db"
	"github.com/stepollo2/apollon-blockbook/fiat"
	"github.com/stepollo2/apollon-blockbook/server"
)
...
var (
	...
	resyncMempoolPeriodMs = flag.Int("resyncmempoolperiod", 20017, "resync mempool period in milliseconds")
)
